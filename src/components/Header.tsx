  ...
  return (
    ...
    >
      <nav className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden py-4 animate-fadeIn bg-white h-[40vh] text-center ">
            {navItems.map((item) => (
              <a
                key={item.name}
                href={item.href}
                className="block font-medium py-3 text-slate-700 hover:text-blue-600 hover:bg-slate-50 px-4 rounded-lg transition-all duration-300"
